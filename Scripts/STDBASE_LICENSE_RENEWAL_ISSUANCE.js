		 ...
		 if (expirationType != null && expirationType != "") {
			 ...
			 if ((expirationType == "Days" || expirationType == "Months" || expirationType == "Years") && recordSettings.action.expirationPeriod != null && recordSettings.action.expirationPeriod != "") {
				 ...
				 if (expirationType == "Days"){
                     ...
                     var newDate = dateAddMonths(orgInitDate, recordSettings.action.expirationPeriod * 12);
					 rB1ExpResult.setExpDate(aa.date.parseDate(newDate));
					 logDebug("orgInitDate2: " + orgInitDate);
					 logDebug("dateAddMonths(orgInitDate, recordSettings.action.expirationPeriod * 12):" + newDate);
				 }else {
